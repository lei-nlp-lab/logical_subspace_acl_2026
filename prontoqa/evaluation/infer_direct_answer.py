...
# -*- coding: utf-8 -*-
"""
Direct Answer baseline for ProntoQA - No CoT, No steering
...
DIRECT_PROMPT_TEMPLATE = """Given the premises and question, answer with ONLY one word: True or False.
...
def parse_direct_answer(text: str):
    """解析直接回答的输出 (ProntoQA: True/False only)
...
def main():
    ...
    ap.add_argument("--out_csv", type=str, default="direct_answer_prontoqa.csv")
    ...
    # 输出结果
    print(f"\n{'='*60}")
    print("Direct Answer Results - ProntoQA (No CoT)")
    print(f"{'='*60}")
