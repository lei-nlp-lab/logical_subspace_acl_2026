...
# ---- ProofWriter/ProntoQA Prompt (三分类：True/False/Uncertain) ----
...
def build_prompt(text: str) -> str:
    """ProofWriter/ProntoQA 的 text 已经包含了 premises 和 question，直接包装即可"""
...
def run_eval_once(mdl, tok, device, samples, max_new_tokens, batch_size,
    ...
    labels = ["True","False","Uncertain"]  # ProofWriter 三分类
    ...
    for layer in tqdm(layers_to_scan, desc="Scanning layers"):
        ...
        for lam in tqdm(lam_vals, desc=f"Layer {layer} λ sweep", leave=False):
            ...
            row = [
                ...
                cm_ij("True","True"), cm_ij("True","False"), cm_ij("True","Uncertain"), cm_ij("True","PARSE_FAILED"),
                cm_ij("False","True"), cm_ij("False","False"), cm_ij("False","Uncertain"), cm_ij("False","PARSE_FAILED"),
                cm_ij("Uncertain","True"), cm_ij("Uncertain","False"), cm_ij("Uncertain","Uncertain"), cm_ij("Uncertain","PARSE_FAILED"),
